...
module HPS_mm_interconnect_0 (
	...
	wire  [105:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> button_pio_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                      // button_pio_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> button_pio_s1_agent:cp_channel
	...
	wire    [4:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> led_pio_s1_agent:cp_channel
	...
	wire  [105:0] fpga_only_master_master_agent_cp_data;                                      // fpga_only_master_master_agent:cp_data -> router:sink_data
	...
	wire  [105:0] jtag_uart_avalon_jtag_slave_agent_rp_data;                                  // jtag_uart_avalon_jtag_slave_agent:rp_data -> router_001:sink_data
	...
	wire  [105:0] sysid_qsys_control_slave_agent_rp_data;                                     // sysid_qsys_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [105:0] button_pio_s1_agent_rp_data;                                                // button_pio_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [105:0] led_pio_s1_agent_rp_data;                                                   // led_pio_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [105:0] dipsw_pio_s1_agent_rp_data;                                                 // dipsw_pio_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [105:0] router_src_data;                                                            // router:src_data -> fpga_only_master_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                           // fpga_only_master_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [4:0] router_src_channel;                                                         // router:src_channel -> fpga_only_master_master_limiter:cmd_sink_channel
	...
	wire  [105:0] fpga_only_master_master_limiter_cmd_src_data;                               // fpga_only_master_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          fpga_only_master_master_limiter_cmd_src_ready;                              // cmd_demux:sink_ready -> fpga_only_master_master_limiter:cmd_src_ready
	wire    [4:0] fpga_only_master_master_limiter_cmd_src_channel;                            // fpga_only_master_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [105:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> fpga_only_master_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                          // fpga_only_master_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [4:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> fpga_only_master_master_limiter:rsp_sink_channel
	...
	wire    [4:0] fpga_only_master_master_limiter_cmd_valid_data;                             // fpga_only_master_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	HPS_mm_interconnect_0_router_001 router_001 (
	...
	HPS_mm_interconnect_0_router_001 router_002 (
	...
	HPS_mm_interconnect_0_router_001 router_003 (
	...
	HPS_mm_interconnect_0_router_001 router_004 (
	...
	HPS_mm_interconnect_0_router_001 router_005 (
