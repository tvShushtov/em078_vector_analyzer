...
module HPS_mm_interconnect_0 (
	...
	wire   [31:0] va_gen_sm_s1_agent_m0_address;                                              // va_gen_sm_s1_agent:m0_address -> va_gen_sm_s1_translator:uav_address
	...
	wire  [127:0] va_gen_sm_s1_agent_rf_source_data;                                          // va_gen_sm_s1_agent:rf_source_data -> va_gen_sm_s1_agent_rsp_fifo:in_data
	...
	wire  [127:0] va_gen_sm_s1_agent_rsp_fifo_out_data;                                       // va_gen_sm_s1_agent_rsp_fifo:out_data -> va_gen_sm_s1_agent:rf_sink_data
	...
	wire  [126:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> sysid_qsys_control_slave_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                      // sysid_qsys_control_slave_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                    // cmd_mux_005:src_channel -> sysid_qsys_control_slave_agent:cp_channel
	...
	wire          va_gen_sm_s1_agent_rp_valid;                                                // va_gen_sm_s1_agent:rp_valid -> router_003:sink_valid
	wire  [126:0] va_gen_sm_s1_agent_rp_data;                                                 // va_gen_sm_s1_agent:rp_data -> router_003:sink_data
	wire          va_gen_sm_s1_agent_rp_ready;                                                // router_003:sink_ready -> va_gen_sm_s1_agent:rp_ready
	wire          va_gen_sm_s1_agent_rp_startofpacket;                                        // va_gen_sm_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          va_gen_sm_s1_agent_rp_endofpacket;                                          // va_gen_sm_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [126:0] button_pio_s1_agent_rp_data;                                                // button_pio_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [126:0] dipsw_pio_s1_agent_rp_data;                                                 // dipsw_pio_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [126:0] cmd_mux_src_data;                                                           // cmd_mux:src_data -> va_gen_sm_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                          // va_gen_sm_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [5:0] cmd_mux_src_channel;                                                        // cmd_mux:src_channel -> va_gen_sm_s1_burst_adapter:sink0_channel
	...
	wire  [126:0] va_gen_sm_s1_burst_adapter_source0_data;                                    // va_gen_sm_s1_burst_adapter:source0_data -> va_gen_sm_s1_agent:cp_data
	wire          va_gen_sm_s1_burst_adapter_source0_ready;                                   // va_gen_sm_s1_agent:cp_ready -> va_gen_sm_s1_burst_adapter:source0_ready
	wire    [5:0] va_gen_sm_s1_burst_adapter_source0_channel;                                 // va_gen_sm_s1_burst_adapter:source0_channel -> va_gen_sm_s1_agent:cp_channel
	...
	wire  [126:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> button_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                      // button_pio_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> button_pio_s1_burst_adapter:sink0_channel
	...
	wire    [5:0] button_pio_s1_burst_adapter_source0_channel;                                // button_pio_s1_burst_adapter:source0_channel -> button_pio_s1_agent:cp_channel
	...
	wire  [126:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> dipsw_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                                      // dipsw_pio_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> dipsw_pio_s1_burst_adapter:sink0_channel
	...
	wire    [5:0] dipsw_pio_s1_burst_adapter_source0_channel;                                 // dipsw_pio_s1_burst_adapter:source0_channel -> dipsw_pio_s1_agent:cp_channel
	...
	wire    [5:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> led_pio_s1_burst_adapter:sink0_channel
	...
	wire    [5:0] led_pio_s1_burst_adapter_source0_channel;                                   // led_pio_s1_burst_adapter:source0_channel -> led_pio_s1_agent:cp_channel
	...
	wire  [126:0] cmd_demux_002_src1_data;                                                    // cmd_demux_002:src1_data -> cmd_mux_001:sink2_data
	...
	wire  [126:0] cmd_demux_002_src5_data;                                                    // cmd_demux_002:src5_data -> cmd_mux_005:sink0_data
	...
	wire  [126:0] rsp_demux_001_src2_data;                                                    // rsp_demux_001:src2_data -> rsp_mux_002:sink1_data
	...
	wire  [126:0] rsp_demux_005_src0_data;                                                    // rsp_demux_005:src0_data -> rsp_mux_002:sink5_data
	...
	HPS_mm_interconnect_0_router_007 router_007 (
	...
	HPS_mm_interconnect_0_router_007 router_008 (
	...
	HPS_mm_interconnect_0_cmd_demux_002 cmd_demux_002 (
		.clk                (clk_0_clk_clk),                                         //        clk.clk
		.reset              (va_gen_sm_reset_reset_bridge_in_reset_reset),           //  clk_reset.reset
	...
	HPS_mm_interconnect_0_cmd_mux_004 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (va_gen_sm_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HPS_mm_interconnect_0_cmd_mux_004 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (va_gen_sm_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HPS_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (va_gen_sm_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HPS_mm_interconnect_0_rsp_demux_004 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (va_gen_sm_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HPS_mm_interconnect_0_rsp_mux_002 rsp_mux_002 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (va_gen_sm_reset_reset_bridge_in_reset_reset), // clk_reset.reset
