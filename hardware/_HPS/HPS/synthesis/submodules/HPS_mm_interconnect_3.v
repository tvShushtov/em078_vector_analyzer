...
module HPS_mm_interconnect_3 (
	...
	HPS_mm_interconnect_3_router router (
	...
	HPS_mm_interconnect_3_router_001 router_001 (
	...
	HPS_mm_interconnect_3_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                           //       clk.clk
		.reset              (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HPS_mm_interconnect_3_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                                      //       clk.clk
		.reset               (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HPS_mm_interconnect_3_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                                      //       clk.clk
		.reset              (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HPS_mm_interconnect_3_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                           //       clk.clk
		.reset               (f2sdram_only_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HPS_mm_interconnect_3_avalon_st_adapter #(
		.inBitsPerSymbol (258),
		.inUsePackets    (0),
		.inDataWidth     (258),
		.inChannelWidth  (0),
